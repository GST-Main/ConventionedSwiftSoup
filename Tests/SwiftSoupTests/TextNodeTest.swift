...
class TextNodeTest: XCTestCase {
	...
	func testTextBean()throws {
		let doc = HTMLParser.parseHTML("<p>One <span>two &amp;</span> three &amp;</p>")!
	...
	func testSplitText()throws {
		let doc: Document = HTMLParser.parseHTML("<div>Hello there</div>")!
	...
	func testWithSupplementaryCharacter()throws {
		#if !os(Linux)
			let doc: Document = HTMLParser.parseHTML(String(Character(UnicodeScalar(135361)!)))!
