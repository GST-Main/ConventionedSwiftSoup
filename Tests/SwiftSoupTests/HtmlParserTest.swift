...
class HtmlParserTest: XCTestCase {
	...
	func testDropsUnterminatedAttribute()throws {
		...
		let doc: Document = HTMLParser.parse(h1)!
		XCTAssertEqual("", doc.getText())
	}

	func testParsesUnterminatedTextarea()throws {
		// don't parse right to end, but break on <p>
		let doc: Document = HTMLParser.parse("<body><p><textarea>one<p>two")!
	...
	func testParsesUnterminatedOption()throws {
		...
		let doc: Document = HTMLParser.parse("<body><p><select><option>One<option>Two</p><p>Three</p>")!
	...
	func testSpaceAfterTag()throws {
		let doc: Document = HTMLParser.parse("<div > <a name=\"top\"></a ><p id=1 >Hello</p></div>")!
	...
	func testHandlesDataOnlyTags()throws {
		...
		let doc: Document = HTMLParser.parse(s)!
	...
	func testHandlesTextArea()throws {
		let doc: Document = HTMLParser.parse("<textarea>Hello</textarea>")!
	...
	func testPreservesSpaceInTextArea()throws {
		...
		let doc: Document = HTMLParser.parse("<textarea>\n\tOne\n\tTwo\n\tThree\n</textarea>")!
	...
	func testPreservesSpaceInScript()throws {
		...
		let doc: Document = HTMLParser.parse("<script>\nOne\n\tTwo\n\tThree\n</script>")!
		let expect = "\nOne\n\tTwo\n\tThree\n"
	...
	func testDoesNotCreateImplicitLists()throws {
		...
		let doc2: Document = HTMLParser.parse(h2)!
	...
	func testHandlesNestedImplicitTable()throws {
		let doc: Document = HTMLParser.parse("<table><td>1</td></tr> <td>2</td></tr> <td> <table><td>3</td> <td>4</td></table> <tr><td>5</table>")!
	...
	func testHandlesWhatWgExpensesTableExample()throws {
		...
		let doc = HTMLParser.parse("<table> <colgroup> <col> <colgroup> <col> <col> <col> <thead> <tr> <th> <th>2008 <th>2007 <th>2006 <tbody> <tr> <th scope=rowgroup> Research and development <td> $ 1,109 <td> $ 782 <td> $ 712 <tr> <th scope=row> Percentage of net sales <td> 3.4% <td> 3.3% <td> 3.7% <tbody> <tr> <th scope=rowgroup> Selling, general, and administrative <td> $ 3,761 <td> $ 2,963 <td> $ 2,433 <tr> <th scope=row> Percentage of net sales <td> 11.6% <td> 12.3% <td> 12.6% </table>")!
	...
	func testHandlesTbodyTable()throws {
		let doc: Document = HTMLParser.parse("<html><head></head><body><table><tbody><tr><td>aaa</td><td>bbb</td></tr></tbody></table></body></html>")!
	...
	func testHandlesImplicitCaptionClose()throws {
		let doc = HTMLParser.parse("<table><caption>A caption<td>One<td>Two")!
	...
	func testNoTableDirectInTable()throws {
		let doc: Document = HTMLParser.parse("<table> <td>One <td><table><td>Two</table> <table><td>Three")!
	...
	func testIgnoresDupeEndTrTag()throws {
		let doc: Document = HTMLParser.parse("<table><tr><td>One</td><td><table><tr><td>Two</td></tr></tr></table></td><td>Three</td></tr></table>")! // two </tr></tr>, must ignore or will close table
	...
	func testNormalisesHeadlessBody()throws {
		let doc = HTMLParser.parse("<html><body><span class=\"foo\">bar</span>")!
		XCTAssertEqual("<html><head></head><body><span class=\"foo\">bar</span></body></html>",
		               TextUtil.stripNewlines(doc.html!))
	}

	func testNormalisedBodyAfterContent()throws {
		let doc = HTMLParser.parse("<font face=Arial><body class=name><div>One</div></body></font>")!
	...
	func testHgroup()throws {
		...
		let doc = HTMLParser.parse("<h1>Hello <h2>There <hgroup><h1>Another<h2>headline</hgroup> <hgroup><h1>More</h1><p>stuff</p></hgroup>")!
	...
	func testRelaxedTags()throws {
		let doc = HTMLParser.parse("<abc_def id=1>Hello</abc_def> <abc-def>There</abc-def>")!
	...
	func testHeaderContents()throws {
		...
		let doc = HTMLParser.parse("<h1>Hello <div>There</div> now</h1> <h2>More <h3>Content</h3></h2>")!
	...
	func testSpanContents()throws {
		...
		let doc = HTMLParser.parse("<span>Hello <div>there</div> <span>now</span></span>")!
	...
	func testNoImagesInNoScriptInHead()throws {
		...
		let doc = HTMLParser.parse("<html><head><noscript><img src='foo'></noscript></head><body><p>Hello</p></body></html>")!
	...
	func testAFlowContents()throws {
		...
		let doc = HTMLParser.parse("<a>Hello <div>there</div> <span>now</span></a>")!
	...
	func testFontFlowContents()throws {
		...
		let doc = HTMLParser.parse("<font>Hello <div>there</div> <span>now</span></font>")!
