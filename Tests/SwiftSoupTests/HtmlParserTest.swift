...
class HtmlParserTest: XCTestCase {
	...
	func testParsesSimpleDocument()throws {
		...
		XCTAssertEqual("foo.png", img.getAttribute(key: "src"))
	...
	func testParsesRoughAttributes()throws {
		...
		let p: Element = doc.body!.getChild(at: 0)!
		XCTAssertEqual("p", p.tagName)
		XCTAssertEqual("foo > bar", p.getAttribute(key: "class"))
	}
	...
	func testDropsUnterminatedAttribute()throws {
		...
		let doc: Document = Parser.parseHTML(h1)!
		XCTAssertEqual("", doc.getText())
	}

	func testParsesUnterminatedTextarea()throws {
		// don't parse right to end, but break on <p>
		let doc: Document = Parser.parseHTML("<body><p><textarea>one<p>two")!
	...
	func testParsesUnterminatedOption()throws {
		...
		let doc: Document = Parser.parseHTML("<body><p><select><option>One<option>Two</p><p>Three</p>")!
	...
	func testSpaceAfterTag()throws {
		let doc: Document = Parser.parseHTML("<div > <a name=\"top\"></a ><p id=1 >Hello</p></div>")!
	...
	func testCreatesDocumentStructure()throws {
		...
		XCTAssertEqual("keywords", head.getElementsByTag("meta").get(index: 0)!.getAttribute(key: "name"))
	...
	func testHandlesDataOnlyTags()throws {
		...
		let doc: Document = Parser.parseHTML(s)!
	...
	func testHandlesTextArea()throws {
		let doc: Document = Parser.parseHTML("<textarea>Hello</textarea>")!
	...
	func testPreservesSpaceInTextArea()throws {
		...
		let doc: Document = Parser.parseHTML("<textarea>\n\tOne\n\tTwo\n\tThree\n</textarea>")!
	...
	func testPreservesSpaceInScript()throws {
		...
		let doc: Document = Parser.parseHTML("<script>\nOne\n\tTwo\n\tThree\n</script>")!
		let expect = "\nOne\n\tTwo\n\tThree\n"
	...
	func testDoesNotCreateImplicitLists()throws {
		...
		let doc2: Document = Parser.parseHTML(h2)!
	...
	func testHandlesNestedImplicitTable()throws {
		let doc: Document = Parser.parseHTML("<table><td>1</td></tr> <td>2</td></tr> <td> <table><td>3</td> <td>4</td></table> <tr><td>5</table>")!
	...
	func testHandlesWhatWgExpensesTableExample()throws {
		...
		let doc = Parser.parseHTML("<table> <colgroup> <col> <colgroup> <col> <col> <col> <thead> <tr> <th> <th>2008 <th>2007 <th>2006 <tbody> <tr> <th scope=rowgroup> Research and development <td> $ 1,109 <td> $ 782 <td> $ 712 <tr> <th scope=row> Percentage of net sales <td> 3.4% <td> 3.3% <td> 3.7% <tbody> <tr> <th scope=rowgroup> Selling, general, and administrative <td> $ 3,761 <td> $ 2,963 <td> $ 2,433 <tr> <th scope=row> Percentage of net sales <td> 11.6% <td> 12.3% <td> 12.6% </table>")!
	...
	func testHandlesTbodyTable()throws {
		let doc: Document = Parser.parseHTML("<html><head></head><body><table><tbody><tr><td>aaa</td><td>bbb</td></tr></tbody></table></body></html>")!
	...
	func testHandlesImplicitCaptionClose()throws {
		let doc = Parser.parseHTML("<table><caption>A caption<td>One<td>Two")!
	...
	func testNoTableDirectInTable()throws {
		let doc: Document = Parser.parseHTML("<table> <td>One <td><table><td>Two</table> <table><td>Three")!
	...
	func testIgnoresDupeEndTrTag()throws {
		let doc: Document = Parser.parseHTML("<table><tr><td>One</td><td><table><tr><td>Two</td></tr></tr></table></td><td>Three</td></tr></table>")! // two </tr></tr>, must ignore or will close table
	...
	func testHandlesBaseTags()throws {
		...
		let doc = Parser.parseHTML(h, baseURI: "http://foo/")!
	...
	func testHandlesProtocolRelativeUrl()throws {
        ...
        let doc = Parser.parseHTML(html, baseURI: base)!
	...
	func testHandlesUnknownTags()throws {
		...
		XCTAssertEqual("bar", foos.first!.getAttribute(key: "title"))
		XCTAssertEqual("qux", foos.last!.getAttribute(key: "title"))
	...
	func testHandlesUnknownInlineTags()throws {
		...
		let doc: Document = Parser.parseBodyFragment(h)!
	...
	func testParsesBodyFragment()throws {
        ...
        let doc: Document = Parser.parseBodyFragment(h, baseURI: "http://example.com")!
	...
	func testHandlesBaseWithoutHref()throws {
        ...
        let doc = Parser.parseHTML(h, baseURI: "http://example.com/")!
		let a: Element = doc.select(cssQuery: "a").first!
		XCTAssertEqual("/foo", a.getAttribute(key: "href"))
		XCTAssertEqual("http://example.com/foo",  a.getAttribute(key: "abs:href"))
	}
	...
	func testHgroup()throws {
		...
		let doc = Parser.parseHTML("<h1>Hello <h2>There <hgroup><h1>Another<h2>headline</hgroup> <hgroup><h1>More</h1><p>stuff</p></hgroup>")!
	...
	func testRelaxedTags()throws {
		let doc = Parser.parseHTML("<abc_def id=1>Hello</abc_def> <abc-def>There</abc-def>")!
	...
	func testHeaderContents()throws {
		...
		let doc = Parser.parseHTML("<h1>Hello <div>There</div> now</h1> <h2>More <h3>Content</h3></h2>")!
	...
	func testSpanContents()throws {
		...
		let doc = Parser.parseHTML("<span>Hello <div>there</div> <span>now</span></span>")!
	...
	func testNoImagesInNoScriptInHead()throws {
		...
		let doc = Parser.parseHTML("<html><head><noscript><img src='foo'></noscript></head><body><p>Hello</p></body></html>")!
	...
	func testAFlowContents()throws {
		...
		let doc = Parser.parseHTML("<a>Hello <div>there</div> <span>now</span></a>")!
	...
	func testFontFlowContents()throws {
		...
		let doc = Parser.parseHTML("<font>Hello <div>there</div> <span>now</span></font>")!
	...
	func testhandlesSolidusInA()throws {
		...
		XCTAssertEqual("/lib/14160711/", a.getAttribute(key: "href"))
	}
