...
open class Node: Equatable, Hashable {
	...
	*/
    ...
    private func addSiblingHtml(_ index: Int, _ html: String)throws {
        ...
        let nodes: Array<Node> = try Parser.parseHTMLFragment(html, context: context, baseURI: getBaseUri())
    ...
    open func wrap(_ html: String)throws->Node? {
        ...
        let context: Element? = parent() as? Element
        var wrapChildren: Array<Node> = try Parser.parseHTMLFragment(html, context: context, baseURI: getBaseUri())
